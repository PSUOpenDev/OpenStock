...
function HomePage() {
    ...
    return (
        <Container fluid>
            <Row>
                <Col md={3} className="font-pacifico clear-yellow text-center fs-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFD700" className="bi bi-activity" viewBox="0 0 16 16">
